const skills = {
  ...
  tools: [
    { name: 'ML Kit', icon: 'SiGoogle', level: 85 },
  ...
  design: [
    ...
    { name: 'Video Editing', icon: 'FaVideo', level: 80 },
    { name: 'UI Design', icon: 'FaPaintBrush', level: 85 },
    { name: 'Wireframing', icon: 'FaSitemap', level: 70 }
  ]
};
